...
//                        "/tMAccount/*/reset");
    	                .excludePathPatterns("/aiverify/v1/login","/aiverify/v1/wxquery","/aiverify/v1/wxlogin","/aiverify/v1/detail/findbyid","/aiverify/v1/detail/update",
                                "/aiverify/v1/logout","/aiverify/v1/tMAccount/modify","/aiverify/v1/wxsubmit","/aiverify/v1/wxaudit","/aiverify/v1/wxcommentquery",
    	...
    	registry.addInterceptor(authCheckInterceptor).addPathPatterns("/aiverify/v1/**").
                ...
                excludePathPatterns("/aiverify/v1/login","/aiverify/v1/wxcommentquery","/aiverify/v1/wxquery","/aiverify/v1/detail/findbyid","/aiverify/v1/detail/update","/aiverify/v1/wxlogin","/aiverify/v1/logout","/aiverify/v1/tMAccount/getCurAccount","/aiverify/v1/tMAccount/getCustomer").
