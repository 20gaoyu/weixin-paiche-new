...
//                        "/tMAccount/*/reset");
    	                .excludePathPatterns("/aiverify/v1/login","/aiverify/v1/wxquery","/aiverify/v1/wxqueryaudit","/aiverify/v1/wxlogin","/aiverify/v1/detail/findbyid","/aiverify/v1/detail/update",
    	...
    	registry.addInterceptor(authCheckInterceptor).addPathPatterns("/aiverify/v1/**").
                ...
                excludePathPatterns("/aiverify/v1/login","/aiverify/v1/wxcommentquery","/aiverify/v1/wxqueryaudit","/aiverify/v1/wxquerydriver","/aiverify/v1/wxquery","/aiverify/v1/detail/findbyid","/aiverify/v1/detail/update","/aiverify/v1/wxlogin","/aiverify/v1/logout","/aiverify/v1/tMAccount/getCurAccount","/aiverify/v1/tMAccount/getCustomer").
